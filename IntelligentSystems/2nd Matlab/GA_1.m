...
%=====================================================================================
% I have made it so that the program makes no progress, the system does not
% produce an optimal solution. By increasing the mutation probability, i
% increase the degree that randomness will occure and certain values in the
% binary string will be flipped. This assists in the ability to make no
% progress. In addition, i have lowered the crossover probability as this
% also aids in worsening the performance of the program.
disp('=============================================================================')
...
Pc=0.08;    % Crossover probability
Pm=0.45;  % Mutation probability
