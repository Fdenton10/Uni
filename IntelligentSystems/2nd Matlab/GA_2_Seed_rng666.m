...
%=======================================================================================
% Improving performance of the program involves achieving a higher value of
% fitness across the generations. There are values we can change to improve
% or worsen the performance ability of the genetic algorithm. I will be
% performance multiple tests to see the trend of changes upon changing
% certain values.
%===========================================================================
% I will first run the default program to see what the output is, and to
% judge my progress on improving it. Default Best Fitness = 0.752
%============================================================================
% The first value I will change is the mutation probability, I will
% increase it from 0.001 to 0.01 to see what effect this has on the output.
% Result = The best fitness value increased to 0.811. However there was a
% large fluctuation throughout generations, I dont think this seems to
% improve the performance. Thus i will reset the value.
%============================================================================7
%The next change I will try will be to lower the crossover value. I will
%lower it from 0.9 to 0.8 to see if this has any effect. This did not seem
%to improve the program at all, with the best fitness value staying the
%same as the default.
%============================================================================
% I will now try to increase the size of the population to see the effect
% it has. i will increase it from 6 to 7. This effected the program in a
% negative way. With the peak performance value not passing 0.2.
%============================================================================
% I will try to increase the population size again to see if it has a
% different effect this time. From 7 to 8. The peak fitness increased to a
% value of 1.62. This is quite a large improvement to the performance.
%============================================================================
% Since the past test made such an improve I will try to increase it to 9;
% This once again lowered the fitness value to a peak of 0.85.
%============================================================================
% Out of curiosity I tried increasing it rather drastically. from 8 to 25.
% This caused a slight increase in peak fitness. To around 1.719. There was
% also a rather small amount of fluctuation once the maximum value was hit.
%============================================================================
disp('===============================================================================')
...
nind=25;     % Size of a chromosome population
